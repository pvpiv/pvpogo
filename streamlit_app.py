...
with cols[0]:
    ...
    css_styles="""
        ...
        if not st.session_state['table_string_butt']:
            ...
            show_custom_boxz = popover.checkbox('Great Remix Cup', on_change=upd_string_sel(0), key='sho_cust')
            show_custom_boxz2 = popover.checkbox('Halloween Cup', on_change=upd_string_sel(1), key='sho_cust1')
            ...
            show_custom_boxz = popover.checkbox('Great Remix Cup', on_change=upd_string_sel(0), key='sho_cust')
            show_custom_boxz2 = popover.checkbox('Halloween Cup', on_change=upd_string_sel(1), key='sho_cust1')
            show_gym_box = popover.checkbox('Gym Attackers/Defenders', on_change=upd_string_sel(2), key='gym_bool_box')
