...
if show_string:
    ...
    lil = placeholderlil.text_input(label = '(Little League Top ' + st.session_state.top_num + ' Search String:', value = make_string("little",st.session_state.top_num),disabled = True)
    grt = placeholdergrt.text_input(label ='(Great League Top ' + st.session_state.top_num + ' Search String: (For most PVP IVs add &0-1attack)', value  = make_string("great",st.session_state.top_num),disabled = True,)
    ult = placeholderult.text_input(label ='(Ultra League Top ' + st.session_state.top_num + ' Search String: (For most PVP IVs add &0-1attack)', value = make_string("ultra",st.session_state.top_num),disabled = True)
    mst = placeholdermstr.text_input(label ='(Master League Top ' + st.session_state.top_num + ' Search String: (For BEST PVP IVs add &3-4*)', value= make_string("master",st.session_state.top_num),disabled = True)
