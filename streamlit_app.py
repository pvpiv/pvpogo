...
with cols[0]:
    ...
    css_styles="""
        ...
        if not st.session_state['table_string_butt']:
            ...
            show_custom_boxz = popover.checkbox('Great Remix Cup', on_change=upd_string_sel(0))
            show_custom_boxz2 = popover.checkbox('Halloween Cup', on_change=upd_string_sel(1))
            ...
            show_custom_boxz = popover.checkbox('Great Remix Cup', on_change=upd_string_sel(0))
            show_custom_boxz2 = popover.checkbox('Halloween Cup', on_change=upd_string_sel(1))
            show_gym_box = popover.checkbox('Gym Attackers/Defenders', on_change=upd_string_sel(2))
